...
#### Takewaways
Our members
Be as involved with other team's status updates as possible. Customer feedback can come in many forms, so even if direct customer interviews aren't an option, there are numerous other sources of customer insights to be found.
